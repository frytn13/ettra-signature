...
{
    /**
     * Hanya Owner yang boleh memperbarui akun internal.
     */
    ...
    /**
     * Aturan validasi perubahan pengguna internal.
     *
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'phone' => [
                ...
                'string',
                'regex:/^08[0-9]{8,13}$/',
                Rule::unique('users', 'phone')->ignore($managedUser?->id),
            ],
            'role' => ['required', Rule::in(User::internalRoles())],
            'is_active' => ['required', 'boolean'],
            'password' => ['nullable', 'confirmed', Password::min(8)->letters()->numbers(), 'max:72'],
        ];
    }
